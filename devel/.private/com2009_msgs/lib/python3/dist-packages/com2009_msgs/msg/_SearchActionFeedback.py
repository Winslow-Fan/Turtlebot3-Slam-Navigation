...
"""autogenerated by genpy from com2009_msgs/SearchActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SearchActionFeedback(genpy.Message):
  _md5sum = "6e5088771ed871b94858f52949affb01"
  _type = "com2009_msgs/SearchActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','com2009_msgs/SearchFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SearchActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = com2009_msgs.msg.SearchFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = com2009_msgs.msg.SearchFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.current_distance_travelled
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_distance_travelled,) = _get_struct_f().unpack(str[start:end])
      return self
