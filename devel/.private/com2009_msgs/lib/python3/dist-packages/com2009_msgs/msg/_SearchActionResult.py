...
"""autogenerated by genpy from com2009_msgs/SearchActionResult.msg. Do not edit."""
import codecs
import sys
...
class SearchActionResult(genpy.Message):
  _md5sum = "17039fd583c707aa9f3ba663a6bbbb85"
  _type = "com2009_msgs/SearchActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','com2009_msgs/SearchResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SearchActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = com2009_msgs.msg.SearchResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = com2009_msgs.msg.SearchResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.result.total_distance_travelled, _x.result.closest_object_distance, _x.result.closest_object_angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.total_distance_travelled, _x.result.closest_object_distance, _x.result.closest_object_angle,) = _get_struct_3f().unpack(str[start:end])
      return self
