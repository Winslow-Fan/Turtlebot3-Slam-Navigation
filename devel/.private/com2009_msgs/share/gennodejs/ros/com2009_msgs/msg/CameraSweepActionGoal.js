...
let CameraSweepGoal = require('./CameraSweepGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class CameraSweepActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CameraSweepGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraSweepActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CameraSweepGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CameraSweepGoal()
    }
...
module.exports = CameraSweepActionGoal;
