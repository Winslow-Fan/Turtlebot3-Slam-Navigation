...
let SearchGoal = require('./SearchGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class SearchActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SearchGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SearchActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SearchGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SearchGoal()
    }
...
module.exports = SearchActionGoal;
