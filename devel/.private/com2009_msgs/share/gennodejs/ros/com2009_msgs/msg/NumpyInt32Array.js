...
class NumpyInt32Array {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NumpyInt32Array(null);
  ...
  static datatype() {
    ...
    return 'com2009_msgs/NumpyInt32Array';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NumpyInt32Array(null);
...
module.exports = NumpyInt32Array;
