...
let SearchFeedback = require('./SearchFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class SearchActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SearchFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SearchFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SearchActionFeedback(null);
    ...
    data.feedback = SearchFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SearchActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SearchFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SearchFeedback()
    }
...
module.exports = SearchActionFeedback;
