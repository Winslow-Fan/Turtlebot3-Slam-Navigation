...
let SearchResult = require('./SearchResult.js');
...
class SearchActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SearchResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SearchActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SearchResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SearchResult()
    }
...
module.exports = SearchActionResult;
