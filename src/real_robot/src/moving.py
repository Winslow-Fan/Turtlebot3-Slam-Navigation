...
class MoveBaseSquare():
    def __init__(self):
        ...
        euler_angles = ( -1.6,-1.6, 1.6, -3.1, -3.1, 0, 0, 0, 0)
        ...
        waypoints.append(Pose(Point(-1, 0, 0), quaternions[0]))
        waypoints.append(Pose(Point(-1, -1, 0), quaternions[1]))
        waypoints.append(Pose(Point(1, -1, 0), quaternions[2]))
        waypoints.append(Pose(Point(1, 1, 0), quaternions[3]))
        waypoints.append(Pose(Point(-1, 1, 0), quaternions[4]))
